...
public class SpeechRecognition : MonoBehaviour
{
    ...
    public string SpeechServiceRegion = "koreacentral";
    ...
    // e.g. fr-fr, es-es, etc.
    string fromLanguage = "korea-central";
    ...
    {
        if (SpeechServiceAPIKey.Length == 0 || SpeechServiceAPIKey == "9c5d0d737b9148f6a60651b99d67aa12")
        {
